...
const beats: Beat[] = [
  ...
  /* in through the shop door, which opens on the bell and swings shut behind him */
  room({ do: "room", name: "door", value: 1, dur: 0.6, at: { gap: 0, plus: 0.0 } }),
  room({ do: "sound", name: "bell", volume: 0.6, at: { gap: 0, plus: 0.1 } }),
  sij({ do: "walk", speed: 1.2, path: [[-2.55, -1.1], [-1.6, 0.35], HIS], face: 0, at: { gap: 0, plus: 0.3 } }),
  room({ do: "room", name: "door", value: 0, dur: 0.9, at: { gap: 0, plus: 2.5 } }),
  ...
  shr({ do: "step", to: [0.47, 0.02], dur: 0.6, at: { gap: 2, plus: -1.15 } }),
  shr({ do: "look", to: { spot: "roll1" }, dur: 0.35, at: { gap: 2, plus: -1.1 } }),
  shr({ do: "lean", amount: 0.26, dur: 0.6, at: { gap: 2, plus: -0.9 } }),
  shr({ do: "reach", hand: "R", to: { prop: "roll1", off: [0, 0.03, 0] }, palm: "down", grip: 0.65, dur: 0.55, at: { gap: 2, plus: -0.85 } }),
  shr({ do: "take", prop: "roll1", hand: "R", grip: "keep", at: { gap: 2, plus: -0.3 } }),
  shr({ do: "look", to: { prop: "bag" }, dur: 0.3, at: { gap: 2, plus: -0.3 } }),
  shr({ do: "reach", hand: "R", to: { prop: "bag", off: [-0.05, 0.19, 0] }, palm: "down", dur: 0.5, at: { gap: 2, plus: -0.25 } }),
  shr({ do: "put", prop: "roll1", into: "bag", off: [-0.06, -0.093, 0.0], at: { gap: 2, plus: 0.25 } }),
  shr({ do: "look", to: { prop: "roll2" }, dur: 0.3, at: { gap: 2, plus: 0.25 } }),
  shr({ do: "reach", hand: "R", to: { prop: "roll2", off: [0, 0.03, 0] }, palm: "down", grip: 0.65, dur: 0.5, at: { gap: 2, plus: 0.3 } }),
  shr({ do: "take", prop: "roll2", hand: "R", grip: "keep", at: { gap: 2, plus: 0.8 } }),
  shr({ do: "look", to: { prop: "bag" }, dur: 0.3, at: { gap: 2, plus: 0.8 } }),
  shr({ do: "reach", hand: "R", to: { prop: "bag", off: [0.05, 0.19, 0] }, palm: "down", dur: 0.5, at: { gap: 2, plus: 0.85 } }),
  shr({ do: "put", prop: "roll2", into: "bag", off: [0.06, -0.093, 0.0], at: { gap: 2, plus: 1.35 } }),
  shr({ do: "rest", hand: "R", at: { gap: 2, plus: 1.4 } }),
  shr({ do: "lean", amount: 0, dur: 0.5, at: { gap: 2, plus: 1.4 } }),
  /* to the bread shelf behind her */
  shr({ do: "look", to: { spot: "loafShelf" }, dur: 0.4, at: { gap: 2, plus: 1.35 } }),
  shr({ do: "walk", path: [[0.95, -0.3], [1.38, -0.86]], face: Math.PI / 2, at: { gap: 2, plus: 1.4 } }),
  sij({ do: "look", to: { hand: "Shruti.R" }, dur: 0.4, at: { gap: 2, plus: -0.8 } }),
  sij({ do: "look", to: { face: R }, dur: 0.5, at: { gap: 2, plus: 1.8 } }),

  /* ---------------------------------------------------------- 2: sliced or whole? */
  /* the loaf down, and turned to him before she asks: a line begun with her
     back to the camera read as a mistake */
  shr({ do: "reach", hand: "R", to: { prop: "loaf", off: [0, 0.04, 0] }, palm: "down", grip: 0.75, dur: 0.45, at: { line: 2, plus: -1.3 } }),
  shr({ do: "take", prop: "loaf", hand: "R", grip: "keep", at: { line: 2, plus: -0.85 } }),
  shr({ do: "reach", hand: "R", to: { body: "present" }, palm: "up", dur: 0.55, at: { line: 2, plus: -0.8 } }),
  shr({ do: "turn", yaw: 3.45, dur: 1.0, at: { line: 2, plus: -0.8 } }),
  shr({ do: "look", to: { face: S }, dur: 0.4, at: { line: 2, plus: -0.5 } }),
  ...
  room({ do: "sound", name: "slicer", volume: 0.6, dur: 2.4, at: { gap: 4, plus: 1.75 } }),
  shr({ do: "open", prop: "loaf", amount: 1, dur: 1.5, at: { gap: 4, plus: 2.0 } }),
  /* she steps aside while it runs, so the camera sees the machine at work */
  shr({ do: "step", to: [1.2, -0.72], dur: 0.6, at: { gap: 4, plus: 1.95 } }),
  room({ do: "room", name: "slicer", value: 0, dur: 0.3, at: { gap: 4, plus: 3.6 } }),
  shr({ do: "step", to: [0.86, -0.84], dur: 0.6, at: { gap: 4, plus: 3.55 } }),
  shr({ do: "reach", hand: "R", to: { prop: "loaf", off: [0, 0.05, 0] }, palm: "down", grip: 0.75, dur: 0.4, at: { gap: 4, plus: 4.1 } }),
  shr({ do: "take", prop: "loaf", hand: "R", grip: "keep", at: { gap: 4, plus: 4.5 } }),
  shr({ do: "reach", hand: "R", to: { body: "present" }, palm: "up", dur: 0.5, at: { gap: 4, plus: 4.55 } }),
  ...
  shr({ do: "turn", yaw: -2.2, dur: 0.9, at: { gap: 4, plus: 5.05 } }),
  shr({ do: "walk", path: [[1.0, -0.3], HERS], face: Math.PI, at: { gap: 4, plus: 5.85 } }),
  ...
  /* he thinks about it, looking over the case */
  sij({ do: "look", to: { spot: "slice1" }, dur: 0.5, hold: 0.7, at: { line: 4, word: "sonst" } }),
  ...
  sij({ do: "look", to: { spot: "slice1" }, dur: 0.4, hold: 0.5, at: { line: 6, word: "zwei" } }),
  ...
  /* ---------------------------------------------------------- the box */
  shr({ do: "step", to: [0.48, 0.02], dur: 0.6, at: { gap: 8, plus: -1 } }),
  shr({ do: "look", to: { prop: "box" }, dur: 0.3, at: { gap: 8, plus: -1 } }),
  shr({ do: "reach", hand: "R", to: { prop: "box", off: [0.0, 0.05, 0.075] }, palm: "down", grip: 0.5, dur: 0.45, at: { gap: 8, plus: -0.8 } }),
  shr({ do: "open", prop: "box", amount: 1, dur: 0.45, at: { gap: 8, plus: -0.35 } }),
  shr({ do: "look", to: { prop: "slice1" }, dur: 0.3, at: { gap: 8, plus: -0.1 } }),
  shr({ do: "lean", amount: 0.22, dur: 0.5, at: { gap: 8, plus: -0.1 } }),
  shr({ do: "reach", hand: "R", to: { prop: "slice1", off: [0, 0.03, 0] }, palm: "down", grip: 0.6, dur: 0.5, at: { gap: 8, plus: -0.05 } }),
  shr({ do: "take", prop: "slice1", hand: "R", grip: "keep", at: { gap: 8, plus: 0.45 } }),
  shr({ do: "look", to: { prop: "box" }, dur: 0.3, at: { gap: 8, plus: 0.45 } }),
  shr({ do: "reach", hand: "R", to: { prop: "box", off: [-0.05, 0.08, 0] }, palm: "down", dur: 0.5, at: { gap: 8, plus: 0.5 } }),
  shr({ do: "put", prop: "slice1", into: "box", off: [-0.05, -0.012, 0], at: { gap: 8, plus: 1 } }),
  shr({ do: "look", to: { prop: "slice2" }, dur: 0.3, at: { gap: 8, plus: 1 } }),
  shr({ do: "reach", hand: "R", to: { prop: "slice2", off: [0, 0.03, 0] }, palm: "down", grip: 0.6, dur: 0.5, at: { gap: 8, plus: 1.05 } }),
  shr({ do: "take", prop: "slice2", hand: "R", grip: "keep", at: { gap: 8, plus: 1.55 } }),
  shr({ do: "look", to: { prop: "box" }, dur: 0.3, at: { gap: 8, plus: 1.55 } }),
  shr({ do: "reach", hand: "R", to: { prop: "box", off: [0.05, 0.08, 0] }, palm: "down", dur: 0.5, at: { gap: 8, plus: 1.6 } }),
  shr({ do: "put", prop: "slice2", into: "box", off: [0.05, -0.012, 0], at: { gap: 8, plus: 2.1 } }),
  shr({ do: "open", prop: "box", amount: 0, dur: 0.45, at: { gap: 8, plus: 2.2 } }),
  shr({ do: "rest", hand: "R", at: { gap: 8, plus: 2.25 } }),
  shr({ do: "lean", amount: 0, dur: 0.5, at: { gap: 8, plus: 2.25 } }),
  /* ringing it up */
  shr({ do: "step", to: [0.52, 0.42], dur: 0.6, at: { gap: 8, plus: 2.4 } }),
  shr({ do: "look", to: { spot: "tillKeys" }, dur: 0.3, at: { gap: 8, plus: 2.5 } }),
  shr({ do: "reach", hand: "L", to: { spot: "tillKeys" }, palm: "down", grip: 0.9, point: 1, dur: 0.4, at: { gap: 8, plus: 2.6 } }),
  shr({ do: "tap", hand: "L", times: 3, at: { gap: 8, plus: 3.05 } }),
  room({ do: "display", text: "8,20 €", at: { gap: 8, plus: 3.6 } }),
  shr({ do: "rest", hand: "L", at: { gap: 8, plus: 3.75 } }),
  sij({ do: "look", to: { prop: "box" }, dur: 0.4, at: { gap: 8, plus: -0.4 } }),
  sij({ do: "look", to: { spot: "tillKeys" }, dur: 0.4, at: { gap: 8, plus: 3.2 } }),
  ...
  /* ---------------------------------------------------------- the wallet */
  sij({ do: "look", to: { hand: "Sijan.R" }, dur: 0.35, at: { gap: 9, plus: -0.6 } }),
  sij({ do: "jacket", open: 1, at: { gap: 9, plus: -0.55 } }),
  sij({ do: "reach", hand: "R", to: { body: "pocketOut" }, dur: 0.4, grip: 0.2, at: { gap: 9, plus: -0.55 } }),
  sij({ do: "reach", hand: "R", to: { body: "pocketIn" }, dur: 0.35, grip: 0.85, at: { gap: 9, plus: -0.15 } }),
  sij({ do: "take", prop: "wallet", hand: "R", grip: "keep", at: { gap: 9, plus: 0.23 } }),
  sij({ do: "reach", hand: "R", to: { body: "pocketOut" }, dur: 0.35, at: { gap: 9, plus: 0.3 } }),
  sij({ do: "jacket", open: 0, dur: 0.4, at: { gap: 9, plus: 0.65 } }),
  sij({ do: "reach", hand: "R", to: { body: "present", off: [0.0, 0.02, -0.08] }, palm: "up", dur: 0.45, at: { gap: 9, plus: 0.67 } }),
  sij({ do: "look", to: { prop: "wallet" }, dur: 0.3, at: { gap: 9, plus: 0.9 } }),
  sij({ do: "open", prop: "wallet", amount: 1, dur: 0.4, at: { gap: 9, plus: 1.15 } }),
  sij({ do: "reach", hand: "L", to: { prop: "card", off: [0.0, 0.01, 0.0] }, palm: "down", grip: 0.6, dur: 0.45, at: { gap: 9, plus: 1.3 } }),
  sij({ do: "take", prop: "card", hand: "L", grip: "keep", at: { gap: 9, plus: 1.8 } }),
  ...
  room({ do: "sound", name: "coins", volume: 0.65, at: { line: 11, word: "passend", plus: -0.02 } }),
  ...
  room({ do: "sound", name: "till", volume: 0.6, at: { gap: 12, plus: 0.6 } }),
  ...
  /* out through the shop door, which opens for him and closes after */
  sij({ do: "walk", path: [[-1.6, 0.4], [-2.55, -0.95], [-2.55, -2.7]], at: { line: 12, end: true, plus: 1.1 } }),
  room({ do: "room", name: "door", value: 1, dur: 0.7, at: { line: 12, end: true, plus: 1.9 } }),
  room({ do: "sound", name: "bell", volume: 0.5, at: { line: 12, end: true, plus: 2.0 } }),
  room({ do: "room", name: "door", value: 0, dur: 1.0, at: { line: 12, end: true, plus: 5.2 } }),
...
export const c018Acted: Acted = {
  ...
  cast: {
    ...
    Sijan: {
      ...
      /* outside, on the pavement behind the glass door */
      start: { x: -2.55, z: -2.5, yaw: -Math.PI / 2 }
    },
    Shruti: {
      look: {
        height: 1.66,
  ...
  /* the business under each gap starts under the line before it (the review
     found 4-6 s of silence here), so the gaps are shorter than the work */
  gaps: { 0: 4.6, 2: 4.4, 4: 5.0, 8: 3.9, 9: 2.0, 11: 1.4, 12: 3.3 },
